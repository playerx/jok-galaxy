...
var engine = require('./jsfiles-loader')
...
while(i < 10000) {
    i++;
    var player = game._addPlayer(engine.Player, 'playerData.name', i);
...
TestClient.prototype._open = function(connection) {
    ...
    this._send(engine.Game.MSG_CREATE_PLAYER, data);
    ...
    this._send(engine.Game.MSG_CREATE_SHIP, data)
}
